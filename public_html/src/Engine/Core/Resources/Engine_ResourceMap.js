...
gEngine.ResourceMap = (function () {
    ...
    // Hold the data of the viewport for scence transition
    var mSmallVP = [20, 340, 100, 100];
    ...
    */
    ...
    var storeSmallVP = function (viewport) {
        mSmallVP = viewport;
    }

    var loadSmallVP = function () { return mSmallVP; }
    ...
    var mPublic = {
        ...
        //</editor-fold>
        loadSmallVP: loadSmallVP,
        storeSmallVP: storeSmallVP
    };
    return mPublic;
}());